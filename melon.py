...
# Removed prompt_toolkit - using keyboard shortcuts instead
...
def main():
    ...
    print("\033[96m💡 Use /new for new chat, /chat to switch, /m for model, /r for reasoning. Press ^C to exit.\033[0m")
    ...
    while True:
        try:
            ...
            # Check for /new command to create a new chat
