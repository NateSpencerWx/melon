...
def display_update_notification(latest_version):
    ...
    print(f"🎉 A new version of Melon is available: {CURRENT_VERSION} -> {latest_version}")
    print(f"To update, run: pip install --upgrade git+https://github.com/{GITHUB_REPO}.git\n")
